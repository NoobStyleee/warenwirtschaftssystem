...
(()=>{
    const e = new Error("Cannot find module '../components/inventory/stats-cards/inventory-table/inventory-table'");
...
(()=>{
    const e = new Error("Cannot find module '../components/inventory/'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
'use client';
...
//# sourceMappingURL=_03lck4j._.js.map