...
function ensureDataFile() {
    ...
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].existsSync(reportsFilePath)) {
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(reportsFilePath, JSON.stringify([]), 'utf8');
    }
}
function getReports() {
    try {
        ensureDataFile();
        const fileData = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(reportsFilePath, 'utf8');
...
function saveReports(reports) {
    try {
        ensureDataFile();
        __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].writeFileSync(reportsFilePath, JSON.stringify(reports, null, 2), 'utf8');
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1n14ko3._.js.map